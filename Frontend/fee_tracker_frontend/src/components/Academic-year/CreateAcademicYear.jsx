    ...
    <div className="app-modal-backdrop fixed inset-0 z-50 flex items-center justify-center">
      <div className="w-full max-w-4xl px-4">
        <div className="app-modal-panel max-h-[88vh] overflow-y-auto rounded-3xl bg-white shadow-2xl">
          <div className="flex items-start justify-between border-b border-slate-200 bg-linear-to-r from-violet-50 to-fuchsia-50 px-8 py-6">
            <div>
              <h1 className="text-3xl font-semibold text-slate-900">Create Academic Year</h1>
          ...
          <form onSubmit={handleCreate} className="px-8 py-8 md:px-10">
